...
public interface BeanBagStore {
     ...
     * @throws IllegalNumberOfBeanBagsAddedException if the number to be added is
     *                                               less than 1
     * @throws BeanBagMismatchException              if the id already exists (as a
     *                                               current in stock bean bag, or
     *                                               one that has been previously
     *                                               stocked in the store, but the
     *                                               other stored elements
     *                                               (manufacturer, name and free
     *                                               text) do not match the
     *                                               pre-existing version
     * @throws IllegalIDException                    if the ID is not a positive
     *                                               eight character hexadecimal
     *                                               number
     * @throws InvalidMonthException                 if the month is not in the
     *                                               range 1 to 12
     */
    void addBeanBags(int num, String manufacturer, String name, String id, short year, byte month)
     ...
     *                                               range 1 to 12
     */
    void addBeanBags(int num, String manufacturer, String name, String id, short year, byte month, String information)
            throws IllegalNumberOfBeanBagsAddedException, BeanBagMismatchException, IllegalIDException,
            InvalidMonthException;
     ...
     */
    void setBeanBagPrice(String id, int priceInPence)
     ...
     * @throws PriceNotSetException                 if the bag is in stock, and
     *                                              there is sufficient stock to
     *                                              meet demand, but the price has
     *                                              yet to be set
     * @throws BeanBagIDNotRecognisedException      if the ID is legal, but does not
     *                                              match any bag in (or previously
     *                                              in) stock
     * @throws IllegalIDException                   if the ID is not a positive
     *                                              eight character hexadecimal
     *                                              number
     */
    void sellBeanBags(int num, String id)
     ...
     * @return unique reservation number, i.e. one not currently live in the system
     ...
     * @throws PriceNotSetException                     if the bag is in stock, and
     *                                                  there is sufficient stock to
     *                                                  meet demand, but the price
     *                                                  has yet to be set
     * @throws BeanBagIDNotRecognisedException          if the ID is legal, but does
     *                                                  not match any bag in (or
     *                                                  previously in) stock
     * @throws IllegalIDException                       if the ID is not a positive
     *                                                  eight character hexadecimal
     *                                                  number
     */
    int reserveBeanBags(int num, String id)
     ...
     */
    void unreserveBeanBags(int reservationNumber) throws ReservationNumberNotRecognisedException;

    /**
     * Method sells beanbags with the corresponding reservation number from the
     * store and removes these sold beanbags from the stock.
     * <p>
     * The state of this BeanBagStore must be be unchanged if any exceptions are
     * thrown.
     *
     * @param reservationNumber unique reservation number used to find beanbag(s) to
     *                          be sold
     * @throws ReservationNumberNotRecognisedException if the reservation number
     *                                                 does not match a current
     *                                                 reservation in the system
     */
    void sellBeanBags(int reservationNumber) throws ReservationNumberNotRecognisedException;

    /**
     * Access method for the number of BeanBags stocked by this BeanBagStore (total
     * of reserved and unreserved stock).
     *
    ...
    /**
     * Method returns number of bean bags with matching ID in stock (total researved
     * and unreserved).
     * <p>
     * The state of this BeanBagStore must be be unchanged if any exceptions are
     * thrown.
     ...
     *                                         character hexadecimal number
     */
    int beanBagsInStock(String id) throws BeanBagIDNotRecognisedException, IllegalIDException;

    /**
     * Method saves this BeanBagStore's contents into a serialised file, with the
     ...
     *                                loading
     */
    void loadStoreContents(String filename) throws IOException, ClassNotFoundException;

    /**
     * Access method for the number of different bean bags currently stocked by this
     * BeanBagStore.
     *
     * @return number of different specific bean bags currently in this store (i.e.
     *         how many different IDs represented by bean bags currently in stock,
     *         including reserved)
     */
    ...
    /**
     * Method to return number of bean bags sold by this BeanBagStore with matching
     * ID.
     * <p>
     * The state of this BeanBagStore must be be unchanged if any exceptions are
     * thrown.
     ...
     *                                         character hexadecimal number
     */
    int getNumberOfSoldBeanBags(String id) throws BeanBagIDNotRecognisedException, IllegalIDException;

    /**
     * Method to return total price of bean bags sold by this BeanBagStore (in
     * pence), i.e. income that has been generated by these sales).
     *
    ...
    /**
     * Method to return total price of bean bags sold by this BeanBagStore (in
     * pence) with matching ID (i.e. income that has been generated by these sales).
     * <p>
     * The state of this BeanBagStore must be be unchanged if any exceptions are
     * thrown.
     *
     * @param id ID of bean bags
     * @return total cost of bean bags sold (in pence) with matching ID
     * @throws BeanBagIDNotRecognisedException if the ID is legal, but does not
     *                                         match any bag in (or previously in)
     *                                         stock
     * @throws IllegalIDException              if the ID is not a positive eight
     *                                         character hexadecimal number
     */
    int getTotalPriceOfSoldBeanBags(String id) throws BeanBagIDNotRecognisedException, IllegalIDException;

    /**
     * Method to return the total price of reserved bean bags in this BeanBagStore
     * (i.e. income that would be generated if all the reserved stock is sold to
     * those holding the reservations).
     *
    ...
    /**
     * Method to return the free text details of a bean bag in stock. If there are
     * no String details for a bean bag, there will be an empty String instance
     * returned.
     * <p>
     * The state of this BeanBagStore must be be unchanged if any exceptions are
     * thrown.
     ...
     *                                         character hexadecimal number
     */
    String getBeanBagDetails(String id) throws BeanBagIDNotRecognisedException, IllegalIDException;

    /**
     * Method empties this BeanBagStore of its contents and resets all internal
     * counters.
     */
    void empty();

    /**
     * Method resets the tracking of number and costs of all bean bags sold. The
     * stock levels of this BeanBagStore and reservations should be unaffected.
     */
     ...
     * @throws BeanBagIDNotRecognisedException if the oldId does not match any bag
     *                                         in (or previously in) stock
     * @throws IllegalIDException              if either argument is not a positive
     *                                         eight character hexadecimal number,
     *                                         or if the replacementID is already in
     *                                         use in the store as an ID
     */
    void replace(String oldId, String replacementId) throws BeanBagIDNotRecognisedException, IllegalIDException;
}
